...
SPLIT_FILES = {
    ...
    'train+val': ['label_data_capture04.json'],
    'train': ['label_data_capture04.json'],
    'val': ['label_data_capture04.json'],
    'test': ['label_data_test.json'],
...
class TuSimple(LaneDatasetLoader):
    ...
    def get_metrics(self, lanes, idx):
        ...
        pred = self.pred2lanes(lanes, org_anno['y_samples'])
