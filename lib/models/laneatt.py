...
class LaneATT(nn.Module):
    def __init__(self,
        ...
        self.left_angles = [60., 49., 39., 30.]
        self.right_angles = [120., 131., 141., 150.]
        self.bottom_angles = [150., 141., 131., 120., 108., 72., 60., 49., 39., 30.]
    ...
    def generate_side_anchors(self, angles, nb_origins, x=None, y=None):
        if x is None and y is not None:
            ...
            starts = [(x, y) for y in np.linspace(1., 0.7, num=nb_origins)]
